# On-Road Automated Vehicles (ENPM818Z)
## Sections 0101 and AEB1
...
Action models (DriveVLM, NVIDIA Alpamayo), imitation learning, and DAgger —
and learn when each approach is the right tool for an automotive-grade
system.
